...
smartcard_certificate certificate_list_first(certificate_list list){ return ((list==NULL)?NULL:list->certificate);}
certificate_list      certificate_list_rest(certificate_list list){  return ((list==NULL)?NULL:list->rest);}
void                  certificate_list_free(certificate_list list){  free(list);}
